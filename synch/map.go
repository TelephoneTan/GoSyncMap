...
// with separate locking or coordination, to make it
// easier to maintain invariants along with the map content.
//
...
// Load returns the value stored in the map for a key, or zero
// value of V if no value is present.
